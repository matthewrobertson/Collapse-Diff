(function() {
  ...
  var butHtml = '<a href="#collapse_diff" style="margin-left: 5px" class="diff-collapse-button btn btn-sm tooltipped tooltipped-nw" rel="nofollow" aria-label="Collapse the file diff">Collapse</a>';
  ...
  var expand = function(button, content, message) {
    ...
    button.setAttribute('aria-label', 'Collapse the file diff')
    button.blur()
  ...
  var collapse = function(button, content, message) {
    ...
    button.setAttribute('aria-label', 'Expand the file diff')
    button.blur()
